...
local fn = function(inst)
    ...
    local magicwand = Recipe("magicwand", {Ingredient("log", 4), Ingredient("rocks", 4), Ingredient("bluegem", 1)}, alvikatab, {SCIENCE = 0})
    magicwand.atlas = "images/inventoryimages/magicwand.xml"
    
end

return MakePlayerCharacter("alvika", prefabs, assets, fn, start_inv)
